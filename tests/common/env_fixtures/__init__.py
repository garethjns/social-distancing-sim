...
def register_test_envs():
    try:
        gym.envs.register(
            id="SDSTests-GymEnvFixedSeedFixture-v0",
    ...
    try:
        gym.envs.register(
            id="SDSTests-GymEnvRandomSeedFixture-v0",
...
def register_sim_test_envs():
    try:
        gym.envs.register(
            id="SDSTests-GymEnvDefaultFixture-v0",
    ...
    try:
        gym.envs.register(
            id="SDSTests-GymEnvSpecifiedFixture-v0",
    ...
    try:
        gym.envs.register(
            id="SDSTests-GymEnvSomePlottingFixture-v0",
    ...
    try:
        gym.envs.register(
            id="SDSTests-GymEnvExtraPlottingFixture-v0",
