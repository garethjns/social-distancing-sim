...
class TestDistancingPolicyAgent(unittest.TestCase):
    ...
    def test_no_actions_outside_active_period(self):
        ...
        agent = self._sut(
            ...
            name="test_agent",
            actions_per_turn=1,
            start_step={"isolate": 25, "reconnect": 35},
            end_step={"isolate": 30, "reconnect": 40},
        )
    ...
    def test_whole_active_period_returns_actions_with_single_actions(self):
        ...
        agent = self._sut(
            ...
            name="test_agent",
            actions_per_turn=1,
            start_step={"isolate": 5, "reconnect": 12},
            end_step={"isolate": 10, "reconnect": 16},
        )
