...
if __name__ == "__main__":
    ...
    graph = env.Graph(
        community_n=50, community_size_mean=15, community_p_in=0.1, community_p_out=0.05
    )
    ...
    pop = env.Environment(
        ...
        observation_space=env.ObservationSpace(graph=graph, test_rate=0.05),
    )
    # Turn logging on
    pop.log_to_file = True

    pop.run(steps=750, plot=True, save=True)
