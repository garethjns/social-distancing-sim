...
6. [Experiments](#experiments)
    1. [social_distancing](#social_distancing)
    ...
    7. [Reinforcement learning agents](#reinforcement_learning)
...
Contains the code defining the agent interface and, currently, 4 basic agents.
  ...
  - masking_agent.**VaccinationAgent** - An agent that randomly provides a supply of masks to alive nodes each turn. By default the masks reduce the chance of infection less than immunity, but both the source and target nodes can potentially contribute to the reduction.. 
...
![Example DummyAgent](https://github.com/garethjns/social-distancing-sim/blob/master/images/dummy_agent_example.gif)   
![Example MaskingAgent](https://github.com/garethjns/social-distancing-sim/blob/master/images/masking_agent_example.gif)   
...
````bash
python3 -m social-distancing-sim.scripts.visual_compare_basic_agents_small
````
...
![Reinforcement agents](https://github.com/garethjns/social-distancing-sim/blob/master/images/multi_agent_rl.png)

Compares two trained reinforcement agents (Linear and deep QAgents) against each other and static policies defined above.

### Train agents
````bash
python3 -m social-distancing-sim.scripts.train_linear_q_learner
python3 -m social-distancing-sim.scripts.train_deep_q_learner
````  

### Run comparison
````bash
python3 -m social-distancing-sim.scripts.stats_compare_rl_to_baseline
````  